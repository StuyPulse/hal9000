-- Preserve the round and number of a manual report in the private breakage alert.
...
begin
  ...
  select t.team_number, e.name, m.match_number, m.match_type, p.display_name
  into team_number, event_name, match_number, match_type, scout_name
  from public.teams t
