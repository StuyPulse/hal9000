...
export function MatchReportSummary({ payload, teamNames, showScoreDetails = true, showStartingPosition = true }: { payload: Record<string, unknown>; teamNames: Record<string, string>; showScoreDetails?: boolean; showStartingPosition?: boolean }) {
