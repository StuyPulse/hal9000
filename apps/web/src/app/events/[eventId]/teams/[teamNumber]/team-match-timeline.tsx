...
export function TeamMatchTimeline({ matches, teamNames, organizationId, eventId, teamId }: { matches: TimelineMatch[]; teamNames: Record<string, string>; organizationId: string; eventId: string; teamId: string }) {
  ...
  async function selectReportSource(match: TimelineMatch, reportId: string) {
    ...
    if (reportId === previousReportId) return;
